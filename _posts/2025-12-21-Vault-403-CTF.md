...
tags: [cyber-events, ctf-writeup, challenge-creation, writeup]
...
dCode has a [Rail Fence (Zig-Zag) Cipher](https://www.dcode.fr/rail-fence-cipher) decoder, which is perfect for this challenge. Inputting the second half of the above message and setting the key as 3, the character for the spaces as dashes, and keeping punctuation and spaces enabled, decrypts the message successfully.
